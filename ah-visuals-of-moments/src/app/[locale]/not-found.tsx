...
export default function NotFound() {
  ...
  useEffect(() => {
    document.title = dictionary.notFound.seoTitle;
  }, [dictionary]);

  return (
    <div className="min-h-[60vh] flex items-center justify-center py-12 px-4">
      <div className="relative w-full max-w-lg text-center bg-[var(--bg-surface)] border border-[var(--border-subtle)] p-8 sm:p-12 rounded-sm shadow-xl space-y-6 overflow-hidden transition-all duration-300">
