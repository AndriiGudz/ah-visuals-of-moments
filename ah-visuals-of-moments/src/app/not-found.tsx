...
export default function RootNotFound() {
  ...
  return (
    <html lang={defaultLocale}>
      <head>
        <title>{dictionary.notFound.seoTitle}</title>
      </head>
      <body className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)] font-sans antialiased flex items-center justify-center p-4">
