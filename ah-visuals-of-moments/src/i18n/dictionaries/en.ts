export const en = {
  ...
  commerce: {
    ...
    contactNotice: "Please provide either Email or Phone",
    addressLabel: "Delivery address (optional)",
    addressPlaceholder: "City, Street, Apartment...",
    notesLabel: "Notes (optional)",
    notesPlaceholder: "Any delivery or order preferences...",
    privacyNotice: "By submitting, you agree to the processing of contact data for order fulfillment.",
    submitOrder: "Submit Order",
    submitting: "Processing...",
    orderAccepted: "Order accepted",
    orderNumber: "Order number",
    orderConfirmationNotice: "We will contact you to confirm the details.",
    soldOutConflict: "This variant has just sold out. Please choose another size or color.",
    close: "Close",
  },
};
